        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCheckInTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    DefaultCheckOutTime = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BedConfiguration = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadGuestId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_CheckDates", "[CheckInDate] < [CheckOutDate]");
                    table.ForeignKey(
                        name: "FK_Bookings_Guests_LeadGuestId",
                        column: x => x.LeadGuestId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BookingRooms_CheckDates", "[CheckInDate] < [CheckOutDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    BookingRoomId = table.Column<int>(type: "int", nullable: true),
                    GuestId = table.Column<int>(type: "int", nullable: false),
                    IsLeadGuest = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingRooms_RoomId_CheckInDate",
                table: "BookingRooms",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Bookings_Property_Code",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guests_PropertyId_LastName_FirstName",
                table: "Guests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_CountryCode",
                table: "Properties",
                column: "CountryCode");
